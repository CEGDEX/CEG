...
class ChainStatus extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string CEG_version = 4;</code>
     */
    private $CEG_version = '';
    /**
     ...
     * @return string
     */
    public function getCEGVersion()
    {
        return $this->CEG_version;
    }
     ...
     * @return $this
     */
    public function setCEGVersion($var)
    {
        GPBUtil::checkString($var, True);
        $this->CEG_version = $var;
