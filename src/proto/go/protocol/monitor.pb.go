...
const (
	...
	MONITOR_MESSAGE_TYPE_MONITOR_MSGTYPE_CEG              MONITOR_MESSAGE_TYPE = 32
...
func (m *CEGStatus) Reset()         { *m = CEGStatus{} }
func (m *CEGStatus) String() string { return proto.CompactTextString(m) }
func (*CEGStatus) ProtoMessage()    {}
func (*CEGStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitor_2647886f338c3a47, []int{5}
}
func (m *CEGStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CEGStatus.Unmarshal(m, b)
}
func (m *CEGStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CEGStatus.Marshal(b, m, deterministic)
}
func (dst *CEGStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CEGStatus.Merge(dst, src)
}
func (m *CEGStatus) XXX_Size() int {
	return xxx_messageInfo_CEGStatus.Size(m)
}
func (m *CEGStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_CEGStatus.DiscardUnknown(m)
}

var xxx_messageInfo_CEGStatus proto.InternalMessageInfo

func (m *CEGStatus) GetGlueManager() *GlueManager {
	if m != nil {
...
func (m *CEGStatus) GetPeerManager() *PeerManager {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*CEGStatus)(nil), "monitor.CEGStatus")
