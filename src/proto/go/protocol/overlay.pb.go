...
type Hello struct {
	...
	CEGVersion          string   `protobuf:"bytes,4,opt,name=CEG_version,json=CEGVersion" json:"CEG_version,omitempty"`
...
func (m *Hello) GetCEGVersion() string {
	if m != nil {
		return m.CEGVersion
	}
	return ""
...
func (m *ChainStatus) GetCEGVersion() string {
	if m != nil {
		return m.CEGVersion
	}
	return ""
