...
class CEGStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.CEGStatus) */ {
 public:
  CEGStatus();
  virtual ~CEGStatus();

  CEGStatus(const CEGStatus& from);

  inline CEGStatus& operator=(const CEGStatus& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const CEGStatus& default_instance();

  void Swap(CEGStatus* other);

  // implements Message ----------------------------------------------

  inline CEGStatus* New() const { return New(NULL); }

  CEGStatus* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CEGStatus& from);
  void MergeFrom(const CEGStatus& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(CEGStatus* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CEGStatus* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .monitor.GlueManager glue_manager = 1;
inline bool CEGStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
inline void CEGStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
inline const ::monitor::GlueManager& CEGStatus::glue_manager() const {
...
inline ::monitor::GlueManager* CEGStatus::mutable_glue_manager() {
...
inline ::monitor::GlueManager* CEGStatus::release_glue_manager() {
...
inline void CEGStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
...
// optional .monitor.PeerManager peer_manager = 2;
inline bool CEGStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
inline void CEGStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
inline const ::monitor::PeerManager& CEGStatus::peer_manager() const {
...
inline ::monitor::PeerManager* CEGStatus::mutable_peer_manager() {
...
inline ::monitor::PeerManager* CEGStatus::release_peer_manager() {
...
inline void CEGStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
